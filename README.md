...
- `VAE_Pareto_Plotting.py`: Shared burn-in, axis-limit, and Pareto plotting helpers used by static and animated comparisons
- `VAE_Pareto_Evolution_Movie.py`: Creates cumulative single-run or grouped Pareto-frontier evolution movies synchronized by training iteration
